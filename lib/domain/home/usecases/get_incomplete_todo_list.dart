...
class GetInCompleteTodoList implements BaseUseCase<List<Todo>, NoParams> {
  final HomeRepository _homeRepository;

  GetInCompleteTodoList({@required HomeRepository homeRepository})
      : assert(homeRepository != null),
        _homeRepository = homeRepository;

  @override
  Future<List<Todo>> call([NoParams params]) async {
    return await _homeRepository.getInCompleteTodoList();
  }
}